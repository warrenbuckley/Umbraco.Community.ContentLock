...
import type { BulkUnlockData, BulkUnlockError, LockContentData, LockContentResponse, LockContentError, UnlockContentData, UnlockContentError } from './types.gen';
...
export class ContentLockService {
    ...
    public static lockContent<ThrowOnError extends boolean = false>(options: Options<LockContentData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<LockContentResponse, LockContentError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
